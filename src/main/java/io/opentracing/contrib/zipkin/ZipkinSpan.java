            ...
            if (Tags.SPAN_KIND_CLIENT.equals(kind)) {
                ...
                if (peer != null) {
                    builder.addAnnotation(Annotation.builder()
                        .endpoint(peer)
                        .timestamp(TimeUtil.epochMicros(peerUpdated))
                        .value(Constants.SERVER_ADDR)
                        .build()
                    );
                }
                ...
                if (peer != null) {
                    builder.addAnnotation(Annotation.builder()
                        .endpoint(peer)
                        .timestamp(TimeUtil.epochMicros(peerUpdated))
                        .value(Constants.CLIENT_ADDR).build()
                    );
                }
            } else if (kind != null) {
